...
export default function BuyerHomepage() {
  ...
  return (
    <div className="min-h-screen ">
      <div className="h-full flex items-center justify-between  px-24  mx-4 pt-10" >
         <Logo />
        <NavMenu />
         <div className="flex items-center gap-3">.</div>
      </div>
      {/* Top Navigation */}
      <header className="bg-gray-900 text-white sticky top-0 z-10 mt-4">
      ...
      <div className="container mx-auto px-4 py-6">
        <div className="flex gap-6">
          {/* Sidebar Filters */}
          <aside
            className={`w-64 bg-muted/70 rounded-lg p-6 h-fit sticky top-24 ${sidebarOpen ? "block" : "hidden md:block"}`}
          >
